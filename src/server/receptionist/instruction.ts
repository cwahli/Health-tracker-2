...
export function buildReceptionistInstruction(lang?: unknown): string {
  return withAgentLanguage([
    ...
    "   - INCOMPLETE UTTERANCE LAW: If message is a stub ('help', 'hi'), keep status: 'needs_info', targetAgent: 'general_receptionist', handoffPayload: null. Emit goal chips on uiForm.",
    "   - A complete demographic profile does NOT imply ready-for-coach. Handoff only when user clearly requested specialist deep work.",
    "",
