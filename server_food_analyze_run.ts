      ...
      if (!skipScoutApplied) {
        ...
        if (isModifySession && (activeMeal || (req.body.activeScoutItems && req.body.activeScoutItems.length > 0))) {
          ...
          scoutPromptText = `The user is modifying/refining an existing logged meal.\n` +
            ...
            `4. CLINICAL ADVICE & NARRATIVE: Provide an updated constructive 35-70 word clinicalAdvice in 2nd person ("You got...") covering key nutritional assets of the FULL updated meal (all dishes at their locked weights — never just the edited item), metabolic/glycemic impact of the change, and actionable next steps/movement.`;
    } else {
