...
content = content.replace("const timeCtx = buildTimeContext({ timezone: userProfile?.timezone, systemCurrentDate });", "const timeCtx = buildTimeContext({ userTimezone: userProfile?.timezone });")
