 ...
 * Defines structured memory, inputs, outputs, UI forms, disambiguation, and benchmark cases.
 */
...
export interface TurnStep {
  ...
  expectedOutput: {
    ...
    mustIncludeInResponse: string[];
    isDisambiguationRequired?: boolean;
    expectsUiForm?: boolean;
    memoryValidation: {
      goalSummaryIncludes: string[];
      stateEquals: string;
      pendingItemsInclude?: string[];
      userProfileSnapshotCheck?: Partial<UserProfileSnapshot>;
    };
    handoffValidation: {
      targetAgent?: TargetAgent;
      hasPayload: boolean;
...
export interface BenchmarkCase {
  ...
  userPayload: {
    promptText: string[];
    jsonPayload: ReceptionistInputPayload;
  };
  expectedOutput: {
    intent: ReceptionistIntent;
    targetAgent: TargetAgent;
  ...
  turns?: TurnStep[];
  agentOutput?: ReceptionistOutput;
}
