...
Body Weight  10 kg
Hemorrhoidal Disease Symptom Score (HDSS)  10 score
Gastroesophageal Reflux Symptom Score (GERD-SS)  10 score
Joint Pain Severity Score  10 score
...
Ideal Body Weight (Target)  10 kg
ApoA1  1.79 g/L
...
| r04 | LDL-C | alias | observation | Very High | ldl | — | — |
...
| r08 | Triglycerides | key | observation | FLAGGED (Please Review Log) | triglycerides | — | — |
...
| r13 | hs-CRP | key | observation | FLAGGED (Please Review Log) | hscrp | — | — |
...
| r38 | Hemorrhoidal Disease Symptom Score (HDSS) | alias | observation | Very High | hemorrhoidal_symptom_score | — | — |
| r39 | Gastroesophageal Reflux Symptom Score (GERD-SS) | alias | observation | Very High | gerd_symptom_score | — | — |
| r40 | Joint Pain Severity Score | key | observation | Very High | joint_pain_severity_score | — | — |
