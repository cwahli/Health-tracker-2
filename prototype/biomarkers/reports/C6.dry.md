...
|---|---|---|---|---|
| undefined | QRISK2 cardiovascular disease 10 year risk score | none | pending | — |
| undefined | HbA1c levl - IFCC standardised | alias | observation | hba1c |

## Scored template vs expected

| id | printed | match | writeTarget | status | key | draft | fail |
|---|---|---|---|---|---|---|---|
| undefined | QRISK2 cardiovascular disease 10 year risk score | none | pending | — | — | qrisk2_10yr_risk | — |
| undefined | HbA1c levl - IFCC standardised | alias | observation | — | hba1c | — | — |
