...
- DYNAMIC PRINTED OCR: Transcribe EVERY literally printed value from the image into 'rawNutritionLabel' using standard normalized keys (servingSize, calories, protein, totalFat, saturatedFat, transFat, totalCarbohydrate, sugar, addedSugar, sodium, salt, totalFibre). OMIT unprinted keys.

STEP 3: 15 DISH NUTRIENTS ESTIMATION (GUARANTEED 14-NUTRIENT PROFILE)
- ZERO FIELD SKIPPING (EVERY DISH MUST HAVE 100% COVERAGE ACROSS ALL 14 KEYS):
  * PACKAGED DISHES WITH PRINTED LABELS: Transcribe all visible printed facts into 'rawNutritionLabel'. In 'nutrients', set any key that was already printed on the label to null (never duplicate printed numbers). For all remaining unprinted keys, you MUST provide realistic numeric portion estimates (e.g. potassium, calcium, iron, magnesium, vitaminD, omega3, addedSugar, totalFibre).
  * UNPACKAGED VISUAL DISHES (no label): Set 'rawNutritionLabel' to null. You MUST populate ALL 14 keys in 'nutrients' with realistic numeric portion estimates (calories, protein, totalFat, saturatedFat, transFat, sugar, addedSugar, totalFibre, sodium, potassium, omega3, calcium, iron, magnesium, vitaminD).
...
{
  "_internalReasoning": "string (Concise description under 20 words)",
