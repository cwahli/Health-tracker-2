...
content = content.replace("const timeCtx = buildTimeContext({ userTimezone: userProfile?.timezone, systemCurrentDate });", "const timeCtx = buildTimeContext({ timezone: userProfile?.timezone, systemCurrentDate });")
